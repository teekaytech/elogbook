			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<h4 align="center">Supervisors Login</h4>
						<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" role="form" class="contactForm">
							<div class="form-group"><br>
								<input class="form-control-two" name="uname" id="email" placeholder="Supervisor ID" required />
								<div class="validation"></div>
							</div><br />
							<div class="form-group">
								<input type="password" class="form-control-two" name="password" id="subject" placeholder="Password" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required />
								<div class="validation"></div>
							</div>
